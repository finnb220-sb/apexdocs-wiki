...
//Apex
import getRelatedRecords from "@salesforce/apex/PC_LocationsRelatedListController.getLocations";
import saveRecords from "@salesforce/apex/PC_LocationsRelatedListController.saveRecords";
...
export default class PcLocationsRelatedList extends LightningElement {
    //component custom properties
    @api limitForRecords;
    @api includeDirectVISNs;
    ...
    // showFilter = true;
    // filterFields = ['StationNumber', 'CreatedByName'];
    ...
    columns = [
        {
            ...
            typeAttributes: {
                ...
                title: "Click to Open Location record",
                name: "openRecord",
                variant: "base",
                type: "text"
            },
    ...
    tableDetails = {
        total: 0,
        sortedBy: "Location Name" // defaulting to Location Name
    };
    ...
    @wire(getRelatedRecords, { territoryId: "$recordId", includeDirectVISNs: "$includeDirectVISNs", includeIndirectVISNs: "$includeIndirectVISNs" })
    loadRelatedRecords({ data, error }) {
        ...
        if (data) {
            ...
            this.displayList.forEach((item) => {
                ...
                recordData.StationNumber = item.record.VAF_Facility_ID__c;
                ...
                recordData.alternativeText = "Location";
            ...
            if (this.showError) {
                console.error("Related Locations Component Error: ", this.error.body.message);
            }
        }
    }
    ...
    handleRowSelection(event) {
        ...
        if (currentSelectionType) {
            ...
            this.selectedRecords = sortList([...this.selectedRecords], { propertyName: "Name", type: "text" }, "asc");
            this.updateTableCheckboxes(this.selectedRecords);
        }
    }
