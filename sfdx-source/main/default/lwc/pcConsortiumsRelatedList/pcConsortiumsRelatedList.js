...
//Apex
import getRelatedRecords from "@salesforce/apex/PC_ConsortiumsRelatedListController.getConsortiums";
import saveRecords from "@salesforce/apex/PC_ConsortiumsRelatedListController.saveRecords";
...
export default class PcConsortiumsRelatedList extends LightningElement {
    ...
    columns = [
        {
            ...
            typeAttributes: {
                ...
                title: "Click to Open Consortium record",
                name: "openRecord",
                variant: "base",
                type: "text"
            },
    ...
    tableDetails = {
        total: 0,
        sortedBy: "Consortium Name" // defaulting to Consortium Name
    };
    ...
    @wire(getRelatedRecords, { territoryId: "$recordId" })
    loadRelatedRecords({ data, error }) {
        ...
        if (data) {
            ...
            this.displayList.forEach((item) => {
                ...
                recordData.alternativeText = "Consortium";
            ...
            if (this.showError) {
                console.error("Related Consortiums Component Error: ", this.error.body.message);
            }
        }
    }
