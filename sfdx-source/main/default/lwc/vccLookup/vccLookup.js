...
export default class Lookup extends NavigationMixin(LightningElement) {
    ...
    handleNewRecordClick(event) {
        ...
        const preNavigateCallback = selection.preNavigateCallback ? selection.preNavigateCallback : () => Promise.resolve();
    ...
    get getFormElementClass() {
        return this.variant === VARIANT_LABEL_INLINE ? "slds-form-element slds-form-element_horizontal" : "slds-form-element";
    }

    get getLabelClass() {
        return this.variant === VARIANT_LABEL_HIDDEN ? "slds-form-element__label slds-assistive-text" : "slds-form-element__label";
    }
    ...
    get getListboxClass() {
        return "slds-dropdown " + (this.scrollAfterNItems ? `slds-dropdown_length-with-icon-${this.scrollAfterNItems} ` : "") + "slds-dropdown_fluid";
    }
