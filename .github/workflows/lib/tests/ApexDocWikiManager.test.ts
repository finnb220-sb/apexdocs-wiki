...
describe('ApexDocWikiManager', () => {
    ...
    describe('generateAndPublishDocs', () => {
        it('should call all necessary methods', async () => {
            ...
            expect(generateHomeMdSpy).toHaveBeenCalledWith(['1.0.0', '2.0.0']);
            expect(commitToWikiSpy).toHaveBeenCalledWith(['1.0.0', '2.0.0']);
            expect(updateHeadersInAllFilesSpy).toHaveBeenCalledWith(['1.0.0', '2.0.0']);
        });
